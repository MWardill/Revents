...
export default function ProfileContent({ profile }: { profile: Profile }) {
    ...
    return (
        <div className="flex w-full gap-3 h-[64vh]">
            <ul className="list bg-base-100 rounded-xl w-1/4">
            ...
            <div className="card p-3 bg-base-100 w-3/4">
                <div className="flex items-center justify-between">
                    <div className="card-title text-2xl ml-3 py-1 text-primary font-bold">
                        {selected.label}
                    </div>
                    {canEdit &&
                        <button onClick={() => setEditMode(!editMode)} className="w-15 btn btn-outline btn-sm btn-primary">
